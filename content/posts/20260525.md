...
tags: ["carpe diem", "index fund", "ETF", "dead poets society", "movie", "link", "book"]
draft: false
---
...
* [winglet of airplane](https://flyusa.com/the-ultimate-guide-to-winglets-on-airplanes/)

* link: [blog - abuse of notation](https://abuseofnotation.github.io)

* link: [the math that explains why bell curves are everywhere](https://www.quantamagazine.org/the-math-that-explains-why-bell-curves-are-everywhere-20260316/)

> [the central limit theorem](https://en.wikipedia.org/wiki/Central_limit_theorem): Through it, the most random, unimaginable chaos can lead to striking predictability.
...
* DC3V flexible LED filament or ceramic hard
